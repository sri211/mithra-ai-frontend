...
const PLANS = [
  ...
  },
  {
    ...
    name: "Elite",
    price: 498,
    tagline: "800 credits every month",
    accent: "#f59e0b",
    features: [
      "800 credits/month — power-user allowance",
      "Everything in Pro",
