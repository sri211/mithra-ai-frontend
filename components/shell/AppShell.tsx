...
const NAV_ITEMS = [
  { href: "/resume-builder", icon: FileText, label: "Resume Builder", color: "#8b5cf6", description: "Build your resume" },
  { href: "/resume-adaptor", icon: Target, label: "Resume Adaptor", color: "#06b6d4", description: "Match to job descriptions" },
  { href: "/job-finder", icon: Search, label: "Job Finder", color: "#10b981", description: "Find the right jobs" },
  { href: "/job-application", icon: Zap, label: "Auto-Apply", color: "#f59e0b", description: "Apply automatically" },
  { href: "/network", icon: Users, label: "Network", color: "#ec4899", description: "Find connections" },
  { href: "/interview-prep", icon: Brain, label: "Interview Prep", color: "#f97316", description: "Practice interviews" },
  { href: "/tracker", icon: BarChart3, label: "Tracker", color: "#6366f1", description: "Track applications" },
];
