...
const HOW_IT_WORKS = [
  { step: "1", title: "Build Your Resume", desc: "Chat with Mithra or paste your LinkedIn profile. AI builds a complete, ATS-ready resume in minutes." },
  { step: "2", title: "Find & Adapt", desc: "Search 50+ portals simultaneously. Paste any JD and Mithra rewrites your resume for maximum match score." },
    ...
    <div style={{ background: "#0a0614", color: "#f8fafc", fontFamily: "Inter, system-ui, sans-serif", minHeight: "100vh" }}>
      ...
      <section className="lp-hero" style={{ padding: "100px 24px 80px", textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
        <div style={{
          ...
          7 Specialist AI Agents · One Career Platform
        </div>
